  ...
  return (
    <div className=" mx-6  mt-4">
      <div className=" flex justify-between  ">
        ...
        <div className="">
          <div className=" relative bg-[#FFEADE8C] w-[300px] h-[400px]">
            <div className=" text-[24px] pt-6 pb-2 italic font-semibold  text-center">
          ...
          <div className=" mt-8 relative bg-[#FFEADE8C] w-[300px] h-[400px]">
            <div className=" text-[24px] pt-6 pb-2 italic font-semibold  text-center">
              <span>Top Contributor this week</span>
            </div>
            <div className=" flex justify-center relative">
